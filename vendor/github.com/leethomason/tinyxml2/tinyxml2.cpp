...
//    fclose( fp );
    ...
    XMLError XMLDocument::SaveFile(RandomAccessIONative *fp, bool compact) {
...
/*static*/ const char *XMLDocument::ErrorIDToName(XMLError errorID) {
    ...
    XMLPrinter::XMLPrinter(RandomAccessIONative *file, bool compact, int depth) :
    ...
    void XMLPrinter::Print(const char *format, ...) {
        ...
        if (_fp) {
//        RandomAccessIONative randomAccessIoNative(_fp);
//        sprintf()
//        randomAccessIoNative.write()
...
//        fwrite ( data , sizeof(char), size, _fp);
            _fp->write(reinterpret_cast<const uint8_t *>(data), size);
        } else {
